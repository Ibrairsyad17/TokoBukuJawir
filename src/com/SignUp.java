...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/icon/book (2).png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Poppins SemiBold", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 136, 51));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Daftar");

        noTelp.setBackground(new java.awt.Color(255, 255, 255));
        noTelp.setForeground(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow"));
        noTelp.setBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow"), 1, true));

        email.setBackground(new java.awt.Color(255, 255, 255));
        email.setForeground(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow"));
        email.setBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow")));
        ...
        address.setForeground(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow"));
        address.setBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow")));

        pwd.setBackground(new java.awt.Color(255, 255, 255));
        pwd.setForeground(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow"));
        pwd.setBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow")));
        ...
        user_name.setBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Actions.Yellow")));
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(email)
                                .addComponent(pwd, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String username = user_name.getText(); // Mengambil teks dari textfield
        String password = pwd.getText(); // Mengambil teks dari password field
        String eml = email.getText(); // Mengambil teks dari email
        String addrs = address.getText(); // Mengambil teks dari address field
        String nomor = noTelp.getText(); // Mengambil teks dari nomor telepon
        
        // Mengecek apakah salah satu kosong atau tidak jika ya menampilkan window error
        if(username.isEmpty() || password.isEmpty() || eml.isEmpty() || addrs.isEmpty() || nomor.isEmpty()){
            ...
            try{
                ...
                String cmd_sql = "INSERT INTO user (nomor_telephone, email, nama_user, alamat, password) VALUES (?, ?, ?, ?, ?)";
                PreparedStatement stm = cnc.prepareStatement(cmd_sql);
                stm.setString(1, nomor);
                stm.setString(2, eml);
                stm.setString(3, username);
                stm.setString(4, addrs);
                stm.setString(5, password);
                int rslt = stm.executeUpdate();
                
                
                if(rslt != 0){
                    JOptionPane.showMessageDialog(this, "Berhasil terdaftar", "Berhasil", JOptionPane.INFORMATION_MESSAGE);
                    TokoBukuJawir tbj = new TokoBukuJawir();
                    tbj.setVisible(true);
                    setVisible(false);
                    
                    ImageIcon img_icn = new ImageIcon("C:/Users/IBRAHIM/OneDrive/Desktop/code/latihanProject/guiJava/book.png");
                    tbj.setIconImage(img_icn.getImage());
