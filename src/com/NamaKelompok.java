 ...
 * @author IBRAHIM
 */
public class NamaKelompok extends javax.swing.JFrame {

    /**
     * Creates new form NamaKelompok
     */
    public NamaKelompok() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NamaKelompok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NamaKelompok().setVisible(true);
            }
        });
    }
